...
import biomLogo from '../../../assets/icon/biom-logo.png'
...
const Header: React.FC = (): JSX.Element => {
  ...
  return (
    <>
      <header className="h-[var(--header-height)] bg-[var(--header-bg)] fixed top-0 left-0 right-0 z-[200] border-b border-black/10">
      ...
      {/* Mobile dropdown */}
      {menuOpen && (
        <div className="fixed top-[var(--header-height)] left-0 right-0 bg-[var(--header-bg)] border-b border-black/10 z-[200] flex flex-col px-4 py-3 gap-1 sm:hidden">
          {' '}
          {items}
        </div>
      )}
