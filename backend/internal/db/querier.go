...
type Querier interface {
	...
	CountDistinctNativeSpeciesObservedInPeriod(ctx context.Context, arg CountDistinctNativeSpeciesObservedInPeriodParams) (int64, error)
	CountDistinctSpeciesObserved(ctx context.Context) (int64, error)
	CountDistinctSpeciesObservedInPeriod(ctx context.Context, arg CountDistinctSpeciesObservedInPeriodParams) (int64, error)
	...
	ListSpeciesCountByTaxaInPeriod(ctx context.Context, arg ListSpeciesCountByTaxaInPeriodParams) ([]ListSpeciesCountByTaxaInPeriodRow, error)
	ObservationTimeSeries(ctx context.Context, arg ObservationTimeSeriesParams) ([]ObservationTimeSeriesRow, error)
	...
	SpeciesObservationTimeSeries(ctx context.Context, arg SpeciesObservationTimeSeriesParams) ([]SpeciesObservationTimeSeriesRow, error)
